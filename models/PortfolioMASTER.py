...
# Consider importing specific modules for clarity if needed elsewhere
...
class PortfolioMASTER(nn.Module):
    ...
    def forward(self, x):
        ...
        for layer in self.encoder_layers:
            ...
            x_spatial_in = x.view(T, B, N, self.d_model).permute(2, 0, 1, 3).contiguous().view(N, B * T, self.d_model)
            ...
            x = x_spatial_out.view(N, B, T, self.d_model).permute(1, 2, 0, 3).contiguous() # [B, T, N, D]
