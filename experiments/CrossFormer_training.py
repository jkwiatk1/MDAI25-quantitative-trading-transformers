...
def main(args):
    # Załaduj konfigurację (zakładamy, że args.config to ścieżka do pliku YAML)
    # Przykład zawartości config.yaml w sekcji model:
    # model:
    #   type: PortfolioCrossformer # Nowy parametr, opcjonalny
    #   d_model: 128
    #   nhead: 4
    #   d_ff: 256             # Nowy parametr dla Crossformer
    #   e_layers: 2           # Nowy parametr dla Crossformer
    #   seg_len: 24           # Nowy parametr dla Crossformer
    #   win_size: 2           # Nowy parametr dla Crossformer
    #   factor: 10            # Nowy parametr dla Crossformer
    #   dropout: 0.1
    # training:
    #   lookback: 96
    #   batch_size: 32
    #   # ... reszta konfiguracji ...
    # data:
    #   preproc_cols_to_use: ['feat1', 'feat2', 'feat3', 'feat4', 'feat5']
    #   tickers: ['AAPL', 'MSFT', 'GOOG'] # Lub ścieżka do pliku CSV
    #   # ... reszta konfiguracji ...
    ...
    logging.info(f"seg_len: {config['model']['seg_len']}")
    logging.info(f"win_size: {config['model']['win_size']}")
    logging.info(f"factor: {config['model']['factor']}")
