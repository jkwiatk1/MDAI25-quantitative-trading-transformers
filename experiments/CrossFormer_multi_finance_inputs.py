...
from experiments.utils.datasets import (
    prepare_sequential_data_CrossFormer,
...
def main(args):
    ...
    config["model"]["patch_size"] = 20 # Długość segmentów czasowych
    ...
    sequences, targets, ticker_mapping = prepare_sequential_data_CrossFormer(
        data_scaled,
        tickers_to_use,
    ...
    # sequences:
    # Batch – liczba próbek w batchu
    # Stocks – liczba spółek
    # Patches – liczba segmentów czasowych
    # Patch_Size – długość każdego segmentu
    # Features – liczba cech
    # targets: przewidujemy wartości dla każdej akcji po lookback dniach.
    ...
    model = build_CrossFormer(
        ...
        num_tickers_to_use=len(tickers_to_use),
